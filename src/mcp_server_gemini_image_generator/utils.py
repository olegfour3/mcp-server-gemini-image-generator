...
async def save_image(image_data: bytes, filename: str, output_path: Optional[str] = None) -> str:
    """Save image data to disk with a descriptive filename.
    
    Args:
        image_data: Raw image data
        filename: Base string to use for generating filename
        output_path: Optional path to save the image. If not provided, uses OUTPUT_IMAGE_PATH
    ...
    try:
        ...
        save_path = output_path or OUTPUT_IMAGE_PATH
